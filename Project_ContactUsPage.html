...
<html lang="en">
    ...
    <body>
        ...
        <footer>
            ...
            <div class="footer">
                <!--Text that displays the McNeese webstore hours-->
                <div class="storeHours">
                    <h3>In-Store Hours</h3>
                ...
                <div class="addressPhonenumber">
                    ...
                    <p>&copy; Copyright 2024 TechTitans Webstore. All rights reserved.</p>
                </div>
                ...
                <div class="contactUs">
                    <h3>Contact Us</h3>
                    <p>
						Need to contact us? Please don't hesitate to use the 
						<a href="TechTitansContactPage.html" onclick="homePage()">Contact Form!</a>
					</p>
