...
<html lang="en">
    ...
    <div id="RomanceContainer">
        <?php
            ...
            $sql = "SELECT comicbookID, name, author, genre, price, picturepath, description FROM comicbooks WHERE genre = 'Romance'";
    ...
    <?php
            ...
            // SQL query to retrieve books data
            $sql = "SELECT comicbookID, name, author, genre, price, picturepath, description FROM comicbooks WHERE genre = 'Horror'";
            $result = mysqli_query($conn, $sql);
    ...
    <?php
            ...
            // SQL query to retrieve books data
            $sql = "SELECT comicbookID, name, author, genre, price, picturepath, description FROM comicbooks WHERE genre = 'Superhero'";
            $result = mysqli_query($conn, $sql);
    ...
    <?php
            ...
            // SQL query to retrieve books data
            $sql = "SELECT comicbookID, name, author, genre, price, picturepath, description FROM comicbooks WHERE genre = 'Manga'";
            $result = mysqli_query($conn, $sql);
